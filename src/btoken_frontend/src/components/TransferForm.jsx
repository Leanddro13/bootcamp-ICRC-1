...
//import necessário para trabalhar com Principal no frontend
...
function TransferForm() {
  ...
  // Função para criar o objeto TransferArgs, necessário para realizar a transferência de tokens
    ...
    // Função para  executar a transfeência de tokens da conta de origem para a conta de destino
    async function transferTokens(){
        ...
        try {
            ...
            // Chama o método tranfer do backend
